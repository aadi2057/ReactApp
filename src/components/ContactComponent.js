...
class Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.email && email.split('').filter(x => x === '@').length !== 1)
            errors.email = "Please enter a valid Emali";
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    id="lastname" name="lastname" placeholder="Last Name" value={this.state.lastname} />    
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    type="tel" id="telnum" name="telnum" placeholder="Tel. Number" value={this.state.telnum} />    
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    id="email" name="email" placeholder="Email" value={this.state.email} />    
