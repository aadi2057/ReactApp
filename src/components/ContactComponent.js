            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(vaues) =>  this.handleSubmit(vaues)}>
                            ...
                            <Row className="form-group">
                                ...
                                <div className="form-check">
                                        <Label check>
                                            <Control.checkbox model=".email" className="form-check-input" id="agree" name="agree"  />{' '}
                            ...
                            <Row className="form-group">
                                <Label hmltFor="message" md={2}>Your Feedback</Label>
                                <Col md={10}>
